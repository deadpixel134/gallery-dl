    ...
    def items(self):
        ...
        for post in posts:
            ...
            for post["num"], file in enumerate(files, 1):
                ...
                url = file["path"]
                if url[0] == "/":
                    url = "https://data2.kemono.party" + url
                elif url.startswith("https://kemono.party/"):
                    url = "https://data2.kemono.party" + url[20:]
